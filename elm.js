...
var _RobertWalter83$calliope$Constants$messageWelcome = 'Welcome back to Calliope!';
var _RobertWalter83$calliope$Constants$messageOpenProject = 'Click here to open.';
var _RobertWalter83$calliope$Constants$messageNewProject = 'Create a brand new project';
var _RobertWalter83$calliope$Constants$urlOpenPolaroid = 'url(\'assets/existing.jpg\')';
var _RobertWalter83$calliope$Constants$urlNewPolaroid = 'url(\'assets/new.jpg\')';
var _RobertWalter83$calliope$Constants$messageError = 'Something went wrong, no project active';
var _RobertWalter83$calliope$Constants$saveButton = 'Save';
var _RobertWalter83$calliope$Constants$pathBackground = 'url(\'assets/bg.png\')';
var _RobertWalter83$calliope$Constants$newProject = 'New Project';
var _RobertWalter83$calliope$Constants$aceTheme = 'ace/theme/textmate';
...
var _RobertWalter83$calliope$Util$filterOut = F2(
	function (list, item) {
		return A2(
			_elm_lang$core$List$filter,
			function (i) {
...
var _RobertWalter83$calliope$Util$transformMaybe = F3(
	function (maybe, outputNothing, outputJust) {
		var _p0 = maybe;
		if (_p0.ctor === 'Nothing') {
			return outputNothing;
		} else {
			return outputJust(_p0._0);
		}
	});
var _RobertWalter83$calliope$Util$updateItemInDict = F3(
	function (dict, key, mapping) {
		return A3(
			_elm_lang$core$Dict$update,
			key,
			function (maybeValue) {
				return A3(_RobertWalter83$calliope$Util$transformMaybe, maybeValue, _elm_lang$core$Maybe$Nothing, mapping);
			},
			dict);
	});
...
var _RobertWalter83$calliope$Util$boxed = function (_p1) {
	var _p2 = _p1;
	var stTopBottom = A2(
		_elm_lang$core$Basics_ops['++'],
...
var _RobertWalter83$calliope$App$cellFromTier = F2(
...
var _RobertWalter83$calliope$App$cells = F2(
	function (gridWidth, project) {
		return A2(
			_elm_lang$core$List$map,
			_RobertWalter83$calliope$App$cellFromTier(gridWidth),
			project.tierList);
	});
var _RobertWalter83$calliope$App$widthFromTierList = function (tierList) {
	var width = A2(
		F2(
			function (x, y) {
				return (x / y) | 0;
...
var _RobertWalter83$calliope$App$cellHeader = F2(
...
var _RobertWalter83$calliope$App$cellHeaderFromTier = F2(
	function (gridWidth, tier) {
		return A2(_RobertWalter83$calliope$App$cellHeader, gridWidth, tier.name);
	});
var _RobertWalter83$calliope$App$cellHeaders = F2(
	function (gridWidth, project) {
		return A2(
			_elm_lang$core$List$map,
			_RobertWalter83$calliope$App$cellHeaderFromTier(gridWidth),
			project.tierList);
	});
var _RobertWalter83$calliope$App$renderStructure = function (project) {
	var gridWidth = _RobertWalter83$calliope$App$widthFromTierList(project.tierList);
	return A2(
		_debois$elm_mdl$Material_Options$div,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$List$append,
					A2(_RobertWalter83$calliope$App$cellHeaders, gridWidth, project),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_RobertWalter83$calliope$App$cellHeader, gridWidth, 'Statistics')
						]))),
				A2(
				_debois$elm_mdl$Material_Grid$grid,
				A2(
				...
				A2(_RobertWalter83$calliope$App$cells, gridWidth, project))
			]));
};
	...
	[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_RobertWalter83$calliope$Constants$messageWelcome)
					]))
			]))
	]);
var _RobertWalter83$calliope$App$errorView = _elm_lang$html$Html$text(_RobertWalter83$calliope$Constants$messageError);
...
var _RobertWalter83$calliope$App$withMdlCmd = F3(
	function (modelMdl, cmd, modelNew) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				modelMdl,
...
var _RobertWalter83$calliope$App$withMdl = F2(
	function (modelMdl, modelNew) {
		return A3(_RobertWalter83$calliope$App$withMdlCmd, modelMdl, _elm_lang$core$Platform_Cmd$none, modelNew);
	});
var _RobertWalter83$calliope$App$moveToHead = F2(
	function (projectToMove, projectsCurrent) {
		var filtered = A2(_RobertWalter83$calliope$Util$filterOut, projectsCurrent, projectToMove);
		return A2(_elm_lang$core$List_ops['::'], projectToMove, filtered);
	});
...
var _RobertWalter83$calliope$App$modelWithProject = function (index) {
	return {viewSelected: 0, projectActive: index, projectsAll: _elm_lang$core$Dict$empty, refreshEditorContent: false, raisedCard: -1};
};
...
var _RobertWalter83$calliope$App$updateProject = F3(
	function (model, key, mapping) {
		var projectsAll = A3(_RobertWalter83$calliope$Util$updateItemInDict, model.projectsAll, key, mapping);
		return _elm_lang$core$Native_Utils.update(
			model,
			{projectsAll: projectsAll});
	});
var _RobertWalter83$calliope$App$timeStamp = F2(
	function (model, timeNow) {
		var stringDate = A3(
			_rluiten$elm_date_extra$Date_Extra_Format$format,
			_rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config,
			_rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config.format.dateTime,
			_elm_lang$core$Date$fromTime(timeNow));
		var key = model.projectActive;
		return A3(
			_RobertWalter83$calliope$App$updateProject,
			model,
			key,
			function (p) {
				return _elm_lang$core$Maybe$Just(
...
var _RobertWalter83$calliope$App$defaultTierList = _elm_lang$core$Native_List.fromArray(
	[
...
var _RobertWalter83$calliope$App$createProject = function (timeNow) {
	...
	var stringDate = _p0._0;
	var stringTime = _p0._1;
	var stringDateTime = _p0._2;
	return {
...
var _RobertWalter83$calliope$App$addNewProject = F2(
	function (modelCurrent, timeNow) {
		...
		return _elm_lang$core$Native_Utils.update(
			modelCurrent,
			{projectActive: indexNew, projectsAll: projectsAll});
	});
var _RobertWalter83$calliope$App$defaultModel = {viewSelected: 0, projectActive: -1, projectsAll: _elm_lang$core$Dict$empty, refreshEditorContent: false, raisedCard: -1};
var _RobertWalter83$calliope$App$ModelMdl = F2(
	function (a, b) {
		return {mdl: a, model: b};
	});
var _RobertWalter83$calliope$App$Model = F5(
	function (a, b, c, d, e) {
		return {viewSelected: a, projectActive: b, projectsAll: c, refreshEditorContent: d, raisedCard: e};
	});
var _RobertWalter83$calliope$App$Project = F8(
	function (a, b, c, d, e, f, g, h) {
		return {title: a, refreshEditor: b, titleEditable: c, dateCreated: d, timeCreated: e, lastChange: f, script: g, tierList: h};
	});
var _RobertWalter83$calliope$App$Script = function (a) {
	return {content: a};
};
var _RobertWalter83$calliope$App$Scene = F2(
	function (a, b) {
		return {name: a, location: b};
	});
var _RobertWalter83$calliope$App$Tier = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _RobertWalter83$calliope$App$EditTitle = F2(
	function (a, b) {
		return {ctor: 'EditTitle', _0: a, _1: b};
	});
var _RobertWalter83$calliope$App$TitleEditable = F2(
	function (a, b) {
		return {ctor: 'TitleEditable', _0: a, _1: b};
	});
var _RobertWalter83$calliope$App$EditorReady = {ctor: 'EditorReady'};
var _RobertWalter83$calliope$App$renderScript = F2(
		...
		return A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Events$on,
					'editor-ready',
					_elm_lang$core$Json_Decode$succeed(_RobertWalter83$calliope$App$EditorReady))
				]),
...
var _RobertWalter83$calliope$App$UpdateEditorContent = function (a) {
	return {ctor: 'UpdateEditorContent', _0: a};
};
var _RobertWalter83$calliope$App$subscriptions = function (modelMdl) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_RobertWalter83$calliope$Ports$updateEditorContent(_RobertWalter83$calliope$App$UpdateEditorContent)
			]));
};
var _RobertWalter83$calliope$App$NoOp = {ctor: 'NoOp'};
var _RobertWalter83$calliope$App$cmdWithTimeNow = function (msg) {
	return A3(
		_elm_lang$core$Task$perform,
		function (_p1) {
...
var _RobertWalter83$calliope$App$TimeStamp = function (a) {
	return {ctor: 'TimeStamp', _0: a};
};
var _RobertWalter83$calliope$App$AddNewProjectNow = function (a) {
	return {ctor: 'AddNewProjectNow', _0: a};
};
var _RobertWalter83$calliope$App$OpenProject = function (a) {
	return {ctor: 'OpenProject', _0: a};
};
var _RobertWalter83$calliope$App$AddNewProject = {ctor: 'AddNewProject'};
...
var _RobertWalter83$calliope$App$renderPolaroid = F5(
	function (modelMdl, urlBackground, userMessage, cardIndex, keyProject) {
		var maybeProject = A2(_elm_lang$core$Dict$get, keyProject, modelMdl.model.projectsAll);
		var textHead = A4(_RobertWalter83$calliope$App$renderProjectTitle, maybeProject, keyProject, modelMdl.mdl, cardIndex);
		var _p3 = (_elm_lang$core$Native_Utils.cmp(keyProject, 0) < 0) ? {ctor: '_Tuple2', _0: _RobertWalter83$calliope$App$AddNewProject, _1: _RobertWalter83$calliope$App$NoOp} : {
			ctor: '_Tuple2',
			_0: _RobertWalter83$calliope$App$NoOp,
			_1: _RobertWalter83$calliope$App$OpenProject(keyProject)
		};
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_debois$elm_mdl$Material_Options$css,
							'background',
							A2(_elm_lang$core$Basics_ops['++'], urlBackground, 'center / cover')),
...
var _RobertWalter83$calliope$App$renderOverview = function (modelMdl) {
	var keys = _elm_lang$core$Dict$keys(modelMdl.model.projectsAll);
	var polaroidsProjects = A2(
		_elm_lang$core$List$indexedMap,
		A3(_RobertWalter83$calliope$App$renderPolaroid, modelMdl, _RobertWalter83$calliope$Constants$urlOpenPolaroid, _RobertWalter83$calliope$Constants$messageOpenProject),
		keys);
	var polaroidCreateNew = A5(_RobertWalter83$calliope$App$renderPolaroid, modelMdl, _RobertWalter83$calliope$Constants$urlNewPolaroid, _RobertWalter83$calliope$Constants$messageNewProject, 0, -1);
	return A2(
		_debois$elm_mdl$Material_Options$div,
		A2(
...
var _RobertWalter83$calliope$App$selectView = F2(
	function (modelCurrent, key) {
		return _elm_lang$core$Native_Utils.update(
			modelCurrent,
			{
				viewSelected: key,
				refreshEditorContent: _RobertWalter83$calliope$App$refreshEditorContent(key)
			});
	});
var _RobertWalter83$calliope$App$update = F2(
	function (msg, modelMdl) {
		...
		switch (_p4.ctor) {
			case 'Mdl':
				return A2(_debois$elm_mdl$Material$update, _p4._0, modelMdl);
			case 'Raise':
				return A2(
					_RobertWalter83$calliope$App$withMdl,
					modelMdl,
					A2(_RobertWalter83$calliope$App$raiseCard, modelCurrent, _p4._0));
			case 'SelectView':
				return A2(
					_RobertWalter83$calliope$App$withMdl,
					modelMdl,
					A2(_RobertWalter83$calliope$App$selectView, modelCurrent, _p4._0));
			case 'UpdateEditorContent':
				return A2(
					_RobertWalter83$calliope$App$withMdl,
					modelMdl,
					A2(_RobertWalter83$calliope$App$updateProjectContent, modelCurrent, _p4._0));
			case 'EditorReady':
				return {
					ctor: '_Tuple2',
					_0: modelMdl,
			...
			case 'AddNewProject':
				return {
					ctor: '_Tuple2',
					_0: modelMdl,
					_1: _RobertWalter83$calliope$App$cmdWithTimeNow(_RobertWalter83$calliope$App$AddNewProjectNow)
				};
			case 'AddNewProjectNow':
				return A2(
					_RobertWalter83$calliope$App$withMdl,
					modelMdl,
					A2(_RobertWalter83$calliope$App$addNewProject, modelCurrent, _p4._0));
			case 'OpenProject':
				return A3(
					_RobertWalter83$calliope$App$withMdlCmd,
					modelMdl,
					_RobertWalter83$calliope$App$cmdWithTimeNow(_RobertWalter83$calliope$App$TimeStamp),
					A2(_RobertWalter83$calliope$App$openProject, modelCurrent, _p4._0));
			case 'TimeStamp':
				return A2(
					_RobertWalter83$calliope$App$withMdl,
					modelMdl,
					A2(_RobertWalter83$calliope$App$timeStamp, modelCurrent, _p4._0));
			case 'Save':
...
var _RobertWalter83$calliope$App$viewMain = function (modelMdl) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_debois$elm_mdl$Material_Options$css, 'background', _RobertWalter83$calliope$Constants$pathBackground)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				renderedContent,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(_RobertWalter83$calliope$Constants$saveButton)
					]))
			]));
};
var _RobertWalter83$calliope$App$layoutOverview = function (modelMdl) {
	return {
		...
		main: _elm_lang$core$Native_List.fromArray(
			[
				_RobertWalter83$calliope$App$stylesheetOverviewHeader,
				_RobertWalter83$calliope$App$viewMain(modelMdl)
			])
	};
};
var _RobertWalter83$calliope$App$layoutDefault = function (modelMdl) {
	return {
		header: _RobertWalter83$calliope$App$viewDefaultHeader(modelMdl),
		drawer: _elm_lang$core$Native_List.fromArray(
			[]),
		tabs: {
			ctor: '_Tuple2',
...
var _RobertWalter83$calliope$App$view = function (modelMdl) {
	var layoutContent = _elm_lang$core$Native_Utils.eq(
		_RobertWalter83$calliope$App$indexToView(modelMdl.model.viewSelected),
	...
	return A4(
		...
		_RobertWalter83$calliope$App$Mdl,
		modelMdl.mdl,
		_RobertWalter83$calliope$App$layoutProperties(modelMdl.model.viewSelected),
