...
var _user$project$Calliope$boxed = F2(
...
var _user$project$Calliope$boxedDefault = A2(_user$project$Calliope$boxed, 80, 20);
var _user$project$Calliope$title = function (t) {
	return A3(
		_debois$elm_mdl$Material_Options$styled,
...
var _user$project$Calliope$renderScript = function (script) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'padding-bottom', _1: '924px'},
						{ctor: '_Tuple2', _0: 'padding-top', _1: '100px'},
						{ctor: '_Tuple2', _0: 'padding-left', _1: '96px'},
						{ctor: '_Tuple2', _0: 'padding-right', _1: '96px'},
						{ctor: '_Tuple2', _0: 'outline', _1: '0px solid transparent'}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Calliope$renderDialog = function (project) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Calliope$boxedDefault,
					_elm_lang$core$Native_List.fromArray(
						[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_debois$elm_mdl$Material_Options$css, 'min-height', '1024px'),
								_debois$elm_mdl$Material_Color$background(_debois$elm_mdl$Material_Color$white),
								A2(_debois$elm_mdl$Material_Options$css, 'font-family', 'monospace'),
								A2(_debois$elm_mdl$Material_Options$css, 'font-size', '24px'),
								A2(_debois$elm_mdl$Material_Options$css, 'font-style', 'normal'),
								A2(_debois$elm_mdl$Material_Options$css, 'font-variant', 'normal'),
								A2(_debois$elm_mdl$Material_Options$css, 'font-weight', '500'),
								A2(_debois$elm_mdl$Material_Options$css, 'line-height', '1.4')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$Calliope$renderScript(project.script)
							]))
					]))
			]));
};
var _user$project$Calliope$cellFromTier = F2(
...
var _user$project$Calliope$cells = F2(
	function (gridWidth, project) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Calliope$cellFromTier(gridWidth),
			project.structure.tierList);
	});
var _user$project$Calliope$widthFromTierList = function (tierList) {
	var width = A2(
		F2(
			function (x, y) {
				return (x / y) | 0;
...
var _user$project$Calliope$cellHeader = F2(
...
var _user$project$Calliope$cellHeaderFromTier = F2(
	function (gridWidth, tier) {
		return A2(_user$project$Calliope$cellHeader, gridWidth, tier.name);
	});
var _user$project$Calliope$cellHeaders = F2(
	function (gridWidth, project) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Calliope$cellHeaderFromTier(gridWidth),
			project.structure.tierList);
	});
var _user$project$Calliope$renderStructure = function (project) {
	var gridWidth = _user$project$Calliope$widthFromTierList(project.structure.tierList);
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_debois$elm_mdl$Material_Options$div,
				A2(_user$project$Calliope$boxed, 20, 20),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_user$project$Calliope$boxed, 12, 0),
							_elm_lang$core$Native_List.fromArray(
								[_debois$elm_mdl$Material_Grid$noSpacing])),
						A2(
							_elm_lang$core$List$append,
							A2(_user$project$Calliope$cellHeaders, gridWidth, project),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Calliope$cellHeader, gridWidth, 'Statistics')
								]))),
						A2(
						_debois$elm_mdl$Material_Grid$grid,
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_user$project$Calliope$boxed, 12, 12),
							_elm_lang$core$Native_List.fromArray(
								[
									_debois$elm_mdl$Material_Grid$noSpacing,
									_debois$elm_mdl$Material_Elevation$e6,
						...
						A2(_user$project$Calliope$cells, gridWidth, project))
					]))
			]));
};
var _user$project$Calliope$defaultStructure = {
...
var _user$project$Calliope$defaultProject = {
	title: 'New Project',
	script: {
	...
	structure: _user$project$Calliope$defaultStructure
};
var _user$project$Calliope$Project = F3(
	function (a, b, c) {
		return {title: a, script: b, structure: c};
	});
var _user$project$Calliope$Script = function (a) {
	return {scenes: a};
};
var _user$project$Calliope$Scene = F2(
	function (a, b) {
		return {name: a, location: b};
	});
var _user$project$Calliope$Structure = function (a) {
	return {tierList: a};
};
var _user$project$Calliope$Tier = F2(
	function (a, b) {
		return {id: a, name: b};
	});

var _user$project$App$subscriptions = function (appState) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$App$updateProjectTitle = F2(
	function (projectOld, titleNew) {
		return _elm_lang$core$Native_Utils.update(
			projectOld,
			{title: titleNew});
	});
var _user$project$App$wrapWithCmdNone = function (appState) {
	return {ctor: '_Tuple2', _0: appState, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$App$renderWelcome = function (appState) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$App$AppState = F4(
	function (a, b, c, d) {
		return {mdl: a, viewSelected: b, project: c, titleEditable: d};
	});
var _user$project$App$EditTitle = function (a) {
	return {ctor: 'EditTitle', _0: a};
};
var _user$project$App$ToggleEditableTitle = {ctor: 'ToggleEditableTitle'};
var _user$project$App$SelectView = function (a) {
	return {ctor: 'SelectView', _0: a};
};
var _user$project$App$layoutProperties = function (viewSelected) {
	return _elm_lang$core$Native_List.fromArray(
		[
			_debois$elm_mdl$Material_Layout$fixedHeader,
			_debois$elm_mdl$Material_Layout$selectedTab(viewSelected),
			_debois$elm_mdl$Material_Layout$onSelectTab(_user$project$App$SelectView)
		]);
};
...
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: {mdl: _debois$elm_mdl$Material$model, viewSelected: 0, project: _user$project$Calliope$defaultProject, titleEditable: false},
	_1: _debois$elm_mdl$Material_Layout$sub0(_user$project$App$Mdl)
};
var _user$project$App$btnEditTitle = F2(
	function (stIcon, mdl) {
		return A5(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_debois$elm_mdl$Material_Button$onClick(_user$project$App$ToggleEditableTitle)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$App$viewHeader = function (appState) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			appState.titleEditable ? _elm_lang$core$Native_List.fromArray(
				[
					A4(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_debois$elm_mdl$Material_Textfield$onInput(_user$project$App$EditTitle),
							_debois$elm_mdl$Material_Textfield$value(appState.project.title),
							A2(_debois$elm_mdl$Material_Options$css, 'margin-right', '20px')
						])),
					A2(_user$project$App$btnEditTitle, 'done', appState.mdl)
				]) : _elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(appState.project.title)
						])),
					A2(_user$project$App$btnEditTitle, 'mode_edit', appState.mdl)
				]))
		]);
};
var _user$project$App$update = F2(
	function (msg, appState) {
		...
		switch (_p0.ctor) {
			case 'SelectView':
				return _user$project$App$wrapWithCmdNone(
					_elm_lang$core$Native_Utils.update(
						appState,
						{viewSelected: _p0._0}));
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$App$Mdl, _p0._0, appState);
			case 'ToggleEditableTitle':
				return _user$project$App$wrapWithCmdNone(
					_elm_lang$core$Native_Utils.update(
						appState,
						{
							titleEditable: _elm_lang$core$Basics$not(appState.titleEditable)
						}));
			default:
				return _user$project$App$wrapWithCmdNone(
					_elm_lang$core$Native_Utils.update(
						appState,
						{
							project: A2(_user$project$App$updateProjectTitle, appState.project, _p0._0)
						}));
		}
	});
var _user$project$App$Dialog = {ctor: 'Dialog'};
var _user$project$App$Structure = {ctor: 'Structure'};
var _user$project$App$Welcome = {ctor: 'Welcome'};
var _user$project$App$rgView = _elm_lang$core$Array$fromList(
	_elm_lang$core$Native_List.fromArray(
		[_user$project$App$Welcome, _user$project$App$Structure, _user$project$App$Dialog]));
var _user$project$App$tabTitles = _elm_lang$core$Array$toList(
	A2(
		...
		_user$project$App$rgView));
var _user$project$App$indexToView = function (i) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$App$Welcome,
		A2(_elm_lang$core$Array$get, i, _user$project$App$rgView));
};
var _user$project$App$viewMain = function (appState) {
	var viewSelected = _user$project$App$indexToView(appState.viewSelected);
	var _p1 = viewSelected;
	switch (_p1.ctor) {
		case 'Welcome':
			return _user$project$App$renderWelcome(appState);
		case 'Dialog':
			return _user$project$Calliope$renderDialog(appState.project);
		default:
			return _user$project$Calliope$renderStructure(appState.project);
	}
};
var _user$project$App$layoutContent = function (appState) {
	return {
		header: _user$project$App$viewHeader(appState),
		drawer: _elm_lang$core$Native_List.fromArray(
			[]),
		tabs: {
			ctor: '_Tuple2',
			_0: _user$project$App$tabTitles,
			_1: _elm_lang$core$Native_List.fromArray(
				[
		...
		main: _elm_lang$core$Native_List.fromArray(
			[
				_user$project$App$viewMain(appState)
			])
	};
};
var _user$project$App$view = function (appState) {
	return A4(
		_debois$elm_mdl$Material_Layout$render,
		_user$project$App$Mdl,
		appState.mdl,
		_user$project$App$layoutProperties(appState.viewSelected),
		_user$project$App$layoutContent(appState));
};
